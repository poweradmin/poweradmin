...
switch($step) {
	...
	case 1:
		...
		echo "  <input type=\"radio\" name=\"language\" value=\"pl_PL\"> Chcę kontynuować po polsku.<br><br>\n";
	...
	case 5:
		...
		if ($db_type == 'mysql') {
			...
			echo "<p><tt>GRANT SELECT, INSERT, UPDATE, DELETE<BR>ON " . $db_name . ".*<br>TO '" . $pa_db_user . "'@'" . $db_host . "'<br>IDENTIFIED BY '" . $pa_db_pass . "';</tt></p>";
