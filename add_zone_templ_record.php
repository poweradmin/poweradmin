...
echo "       </tr>\n";
echo "       <tr>\n";
echo "        <td class=\"n\"><input type=\"text\" name=\"name\" value=\"" . $name . "\"></td>\n";
...
echo "         </select>\n";
echo "        </td>\n";
echo "        <td class=\"n\"><input type=\"text\" name=\"content\" value=\"" . $content . "\"></td>\n";
echo "        <td class=\"n\"><input type=\"text\" name=\"prio\" value=\"" . $prio . "\"></td>\n";
echo "        <td class=\"n\"><input type=\"text\" name=\"ttl\" value=\"" . $ttl . "\"</td>\n";
echo "       </tr>\n";
echo "     <tr>\n";
