...
echo "          <li><input type=\"text\" name=\"domain\" value=\"\"></li>\n";
echo "         </ul>\n";
echo "        </td>\n";
echo "       </tr>\n";
echo "       <tr>\n";
...
echo "        <td class=\"n\"><input type=\"checkbox\" name=\"dnssec\" value=\"1\" " . ($pdnssec_use ? "checked" : "") . "></td>\n";
echo "       </tr>\n";
echo "       <tr>\n";
echo "        <td class=\"n\">&nbsp;</td>\n";
echo "        <td class=\"n\">\n";
echo "         <input type=\"submit\" name=\"submit\" value=\"" . _('Add zone') . "\">\n";
echo "        </td>\n";
echo "       </tr>\n";
echo "      </table>\n";
echo "     </form>\n";
