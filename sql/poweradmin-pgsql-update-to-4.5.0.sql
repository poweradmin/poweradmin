...
CREATE TABLE IF NOT EXISTS "public"."log_changesets" (
...
CREATE INDEX IF NOT EXISTS "idx_log_record_changes_changeset_id" ON "public"."log_record_changes" USING btree ("changeset_id");
...
CREATE INDEX IF NOT EXISTS "idx_log_api_created_at" ON "public"."log_api" USING btree ("created_at");
