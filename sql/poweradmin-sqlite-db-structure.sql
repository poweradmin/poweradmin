...
INSERT INTO "users" ("id", "username", "password", "fullname", "email", "description", "perm_templ", "active", "use_ldap") VALUES (1,	'admin',	'$2y$12$/BEBLjnv2wHRXUHZjArvdeOwE9arW4z3mmKRMNI/1ghlpasGuvVM2',	'Administrator',	'admin@example.net',	'Administrator with full rights.',	1,	1,	0);
