...
$iface_add_reverse_record = true; // Displays a checkbox for adding a PTR record in reverse zone
$iface_add_forward_record = false; // Displays a checkbox for adding an A/AAAA record in forward zone
