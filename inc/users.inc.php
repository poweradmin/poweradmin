 ...
 *        	Exclude User ID
 * @param int $rowstart
 *        	Startring row number
 * @param int $rowamount
 *        	Number of rows to return this query
 *
 ...
 * @param boolean $return_name_only
 ...
 *
 * @param mixed[] $details
 *        	Permission template details [templ_name,templ_descr,perm_id]
 *
 * @return boolean true on success, false otherwise
 */
