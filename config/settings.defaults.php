...
return [
    ...
    'interface' => [
        ...
        'session_timeout' => 1800,            // Session timeout in seconds (30 minutes); must be above 0, the timeout cannot be disabled
        'rows_per_page' => 10,
    ...
    'misc' => [
        ...
        'edit_conflict_resolution' => 'last_writer_wins', // Options: 'last_writer_wins', 'only_latest_version'
