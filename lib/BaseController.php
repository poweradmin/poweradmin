...
abstract class BaseController
{
     ...
     * getPdnsCapabilities() calls this itself once the cached entry expires;
     * call it directly only where a fresh version matters more than the
     * cached one - e.g. the dashboard.
     */
