...
class EditController extends BaseController
{
    ...
    public function run(): void
    {
        ...
        $row_start = 0;
        if (isset($_GET["start"])) {
            $row_start = (max(1, (int)$_GET["start"]) - 1) * $iface_rowamount;
        }
    ...
    /**
     * Checked against a literal allowlist before assignment, so the result is
     * safe to interpolate into ORDER BY.
     *
