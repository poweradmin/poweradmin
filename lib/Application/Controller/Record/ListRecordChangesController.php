...
class ListRecordChangesController extends BaseController
{
    ...
    private function showRecordChanges(): void
    {
        ...
        $this->render('list_record_changes.html', [
            ...
            'zone_id_filter' => (string) $this->httpRequest->getQueryParam('zone_id', ''),
            'window_filter' => (string) $this->httpRequest->getQueryParam('window', ''),
            'date_from' => (string) $this->httpRequest->getQueryParam('date_from', ''),
            'date_to' => (string) $this->httpRequest->getQueryParam('date_to', ''),
