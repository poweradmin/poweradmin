 ...
 *
 * ZoneTemplateAccessPolicy owns the permission checks, ZoneTemplateWriteService and
 * ZoneTemplateRecordService the validation, ZoneTemplatePlaceholders the placeholder
 * expansion; every SQL statement behind those decisions lives here.
 */
