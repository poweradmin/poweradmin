...
class ApiKey implements JsonSerializable
{
     ...
     *
     * @return string The creator fullname
     */
     ...
     *
     * @param string $creatorFullname The creator fullname to set
     */
    public function setCreatorFullname(string $creatorFullname): void
    {
