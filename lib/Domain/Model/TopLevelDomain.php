...
class TopLevelDomain
{
    ...
    private const TOP_LEVEL_DOMAINS = array(
        ...
        "mtn", "mtr", "mu", "museum", "music", "mv", "mw", "mx", "my", "mz", "na",
        ...
        "nissan", "nissay", "nl", "no", "nokia", "norton", "now", "nowruz", "nowtv",
        "np", "nr", "nra", "nrw", "ntt", "nu", "nyc", "nz", "obi", "observer",
        "office", "okinawa", "olayan", "olayangroup", "ollo", "om", "omega", "one",
        "ong", "onl", "online", "ooo", "open", "oracle", "orange", "org", "organic",
        "origins", "osaka", "otsuka", "ott", "ovh", "pa", "page", "panasonic",
        "paris", "pars", "partners", "parts", "party", "pay", "pccw", "pe", "pet",
        "pf", "pfizer", "pg", "ph", "pharmacy", "phd", "philips", "phone", "photo",
        ...
        "politie", "porn", "post", "pr", "pramerica", "praxi", "press", "prime",
