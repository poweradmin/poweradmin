...
class TopLevelDomain
{
    ...
    // Updated on 2026-09-03 - 1438 TLDs
    ...
    const TOP_LEVEL_DOMAINS = array(
        ...
        "be", "beats", "beauty", "beer", "berlin", "best", "bestbuy", "bet",
        "bf", "bg", "bh", "bharti", "bi", "bible", "bid", "bike", "bing",
        "bingo", "bio", "biz", "bj", "black", "blackfriday", "blockbuster",
        ...
        "call", "calvinklein", "cam", "camera", "camp", "canon", "capetown",
        "capital", "capitalone", "car", "caravan", "cards", "care", "career",
        "careers", "cars", "casa", "case", "cash", "casino", "cat",
        ...
        "doctor", "dog", "domains", "dot", "download", "drive", "dtv",
        ...
        "graphics", "gratis", "green", "gripe", "grocery", "group", "gs",
        "gt", "gu", "gucci", "guge", "guide", "guitars", "guru", "gw", "gy",
        ...
        "kyoto", "kz", "la", "lacaixa", "lamborghini", "lamer", "land",
        ...
        "lincoln", "link", "live", "living", "lk", "llc", "llp", "loan",
        "loans", "locker", "locus", "lol", "london", "lotte", "lotto", "love",
        ...
        "marketing", "markets", "marriott", "marshalls", "mattel", "mba",
        "mc", "mckinsey", "md", "me", "med", "media", "meet", "melbourne",
        "meme", "memorial", "men", "menu", "merck", "merckmsd", "mg", "mh",
        "miami", "microsoft", "mil", "mini", "mint", "mit", "mitsubishi",
        ...
        "realtor", "realty", "recipes", "red", "redumbrella", "rehab",
        ...
        "sd", "se", "search", "seat", "secure", "security", "seek", "select",
        ...
        "tw", "tz", "ua", "ubank", "ubs", "ug", "uk", "unicom", "university",
        "uno", "uol", "ups", "us", "uy", "uz", "va", "vacations", "vana",
        ...
        "vlaanderen", "vn", "vodka", "volvo", "vote", "voting", "voto",
        "voyage", "vu", "wales", "walmart", "walter", "wang", "wanggou",
        ...
        "wtc", "wtf", "xbox", "xerox", "xihuan", "xin", "xn--11b4c3d",
    ...
    {
        self::$VALID_TOP_LEVEL_DOMAINS = array_merge(self::TOP_LEVEL_DOMAINS, self::SPECIAL_TOP_LEVEL_DOMAINS);
    }
