...
if ($confirm == '1') {
    ...
    if ($user_is_zone_owner == "1") {
        ...
        echo "     <input type=\"button\" onClick=\"location.href='dnssec_delete_key.php?id=" . $zone_id . "&amp;key_id=$key_id&amp;confirm=1'\" value=\"" . _('Yes') . "\">\n";
        echo "     <input type=\"button\" onClick=\"location.href='dnssec.php?id=" . $zone_id . "'\" value=\"" . _('No') . "\">\n";
    } else {
