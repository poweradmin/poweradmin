...
/**
 * Integration test for RecordRepository::getRecordsFromDomainId() apex pinning.
 *
...
class RecordRepositoryApexSortingIntegrationTest extends TestCase
{
    ...
    private function makeRepository(): RecordRepository
    {
        ...
        return new RecordRepository($this->db, $config);
    }
