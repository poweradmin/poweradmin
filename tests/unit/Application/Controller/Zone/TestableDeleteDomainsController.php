 ...
 * seam. checkCondition() and redirect() end the request in production, so each
 * throws a ControllerHalt; render() only records.
 */
class TestableDeleteDomainsController extends DeleteDomainsController
{
