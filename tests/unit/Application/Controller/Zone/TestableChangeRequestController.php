...
/**
 * Captures the page, redirect or error the controller would have produced,
 * since the real methods write output and exit.
 */
class TestableChangeRequestController extends ChangeRequestController
{
