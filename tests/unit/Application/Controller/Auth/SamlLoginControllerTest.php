...
use Poweradmin\Application\Controller\Auth\SamlLoginController;
use Poweradmin\Domain\Model\SessionEntity;
use Poweradmin\Application\Service\Auth\AuthenticationService;
use Poweradmin\Tests\Unit\Application\Controller\SeamControllerTestCase;

/**
 * Pins the collaborator wiring of the SAML login endpoint: when SAML is
 ...
 */
#[CoversClass(SamlLoginController::class)]
class SamlLoginControllerTest extends SeamControllerTestCase
{
    public function testDisabledSamlBouncesToLoginThroughTheSharedAuthenticationService(): void
    {
        $config = $this->configure(['saml' => ['enabled' => false]]);
        ...
        $controller = new SamlLoginController([], $this->environment($config));
        $controller->run();
    }
}
