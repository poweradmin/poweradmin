 ...
 */
#[CoversClass(SamlCallbackController::class)]
class SamlCallbackControllerTest extends SeamControllerTestCase
{
    public function testDisabledSamlBouncesToLoginThroughTheSharedAuthenticationService(): void
    {
        ...
        $controller = new SamlCallbackController([], $this->environment($config));
        $controller->run();
    }
}
