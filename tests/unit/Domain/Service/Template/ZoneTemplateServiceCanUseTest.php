...
class ZoneTemplateServiceCanUseTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->zoneTemplate = ZoneTemplateServiceBuilder::build(new DbZoneTemplateRepository($db, $config, $backend), $config, $backend, $this->createMock(PermissionService::class), new SessionActor(new ArraySession()), new NullLogger());
    }
