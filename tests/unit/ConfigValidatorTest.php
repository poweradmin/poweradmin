...
class ConfigValidatorTest extends TestCase
{
    ...
    public function testLoggingLevelIsValid(): void
    {
        $config = [
            'interface' => [
                'rows_per_page' => 10,
        ...
        $this->assertTrue($validator->validate());
        $this->assertArrayNotHasKey('logging.level', $validator->getErrors());
    }

    public function testLoggingLevelRejectsWarnAbbreviation(): void
    {
        $config = [
            'interface' => [
                'rows_per_page' => 10,
        ...
        $this->assertArrayHasKey('logging.level', $validator->getErrors());
    }

    public function testLoggingLevelMayBeAbsent(): void
    {
        $config = [
            'interface' => [
                'rows_per_page' => 10,
