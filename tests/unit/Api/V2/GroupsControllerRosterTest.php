...
class GroupsControllerRosterTest extends TestCase
{
    ...
    public function testNonUeberuserDoesNotSeeMemberRoster(): void
    {
        ...
        $this->assertSame([], $body['data']['members'], 'A non-ueberuser must not receive the member roster.');
        $this->assertSame(2, $body['data']['member_count'], 'The aggregate member count is still returned.');
    }
    ...
    {
        $controller = (new ReflectionClass(GroupsController::class))->newInstanceWithoutConstructor();
