 ...
 *
 * Updated on 2026-02-05 - 1438 TLDs
...
return [
    'tlds' => [
        ...
        'black', 'blackfriday', 'blockbuster', 'blog', 'bloomberg', 'blue', 'bm',
        'bms', 'bmw', 'bn', 'bnpparibas', 'bo', 'boats', 'boehringer', 'bofa',
        ...
        'ist', 'istanbul', 'it', 'itau', 'itv', 'jaguar', 'java', 'jcb', 'je',
        'jeep', 'jetzt', 'jewelry', 'jio', 'jll', 'jm', 'jmp', 'jnj', 'jo',
        'jobs', 'joburg', 'jot', 'joy', 'jp', 'jpmorgan', 'jprs', 'juegos',
        'juniper', 'kaufen', 'kddi', 'ke', 'kerryhotels', 'kerryproperties',
        'kfh', 'kg', 'kh', 'ki', 'kia', 'kids', 'kim', 'kindle', 'kitchen',
        ...
        'mtr', 'mu', 'museum', 'music', 'mv', 'mw', 'mx', 'my', 'mz', 'na', 'nab',
        ...
        'obi', 'observer', 'office', 'okinawa', 'olayan', 'olayangroup', 'ollo',
        ...
        'pn', 'pnc', 'pohl', 'poker', 'politie', 'porn', 'post', 'pr', 'praxi',
        ...
        'shouji', 'show', 'si', 'silk', 'sina', 'singles', 'site', 'sj', 'sk',
        'ski', 'skin', 'sky', 'skype', 'sl', 'sling', 'sm', 'smart', 'smile',
        ...
        'support', 'surf', 'surgery', 'suzuki', 'sv', 'swatch', 'swiss', 'sx',
        'sy', 'sydney', 'systems', 'sz', 'tab', 'taipei', 'talk', 'taobao',
        'target', 'tatamotors', 'tatar', 'tattoo', 'tax', 'taxi', 'tc', 'tci',
        'td', 'tdk', 'team', 'tech', 'technology', 'tel', 'temasek', 'tennis',
        ...
        'wtf', 'xbox', 'xerox', 'xihuan', 'xin', 'xn--11b4c3d', 'xn--1ck2e1b',
