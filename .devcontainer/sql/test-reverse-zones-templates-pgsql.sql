-- PostgreSQL Test Data: Reverse Zones and Zone Templates
-- Purpose: Add reverse zones and zone templates for comprehensive E2E testing
-- Requires: test-users-permissions-pgsql.sql to be run first
--
-- This script creates:
...
--
-- Usage: docker exec -i -e PGPASSWORD=poweradmin postgres psql -U pdns -d pdns < test-reverse-zones-templates-pgsql.sql
...
INSERT INTO domains (name, type) VALUES ('2.0.192.in-addr.arpa', 'MASTER')
ON CONFLICT (name) DO NOTHING;

-- Create IPv6 reverse zone (2001:db8::/32)
INSERT INTO domains (name, type) VALUES ('8.b.d.0.1.0.0.2.ip6.arpa', 'MASTER')
ON CONFLICT (name) DO NOTHING;
