...
-- Template #1: Administrator (already exists in base schema with überuser permission)
...
-- =============================================================================
-- PERMISSION TEMPLATE ITEMS (Permission Assignments)
-- =============================================================================

-- Zone Manager Permissions (Template #2)
INSERT OR IGNORE INTO "perm_templ_items" ("templ_id", "perm_id") VALUES
