...
test.describe('Supermaster CRUD Operations', () => {
  ...
  test.describe('IPv6 Supermaster Edit and Delete', () => {
    test('should edit supermaster with IPv6 address', async ({ adminPage: page }) => {
      ...
      if (await row.count() > 0) {
        const editLink = row.locator('a[href*="edit_supermaster"]').first();
    ...
    test('should delete supermaster with IPv6 address', async ({ adminPage: page }) => {
  ...
  test.afterAll(async ({ browser }) => {
    ...
    const testIPs = ['192.168.100.1', '192.168.200.1', '192.168.250.1', '192.168.251.1', '2001:db8::200', '2001:db8::201'];
