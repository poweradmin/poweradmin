 ...
 * covering the whois.html template.
 */
...
test.describe('WHOIS Lookup Page', () => {
  test.describe('Page Access', () => {
    test('admin should access WHOIS lookup page', async ({ adminPage: page }) => {
      await page.goto('/index.php?page=whois');
    ...
    test('manager should access WHOIS lookup page', async ({ managerPage: page }) => {
      await page.goto('/index.php?page=whois');
  ...
  test.describe('Search Form', () => {
    test('should display domain input field or disabled message', async ({ adminPage: page }) => {
      await page.goto('/index.php?page=whois');
    ...
    test('should display lookup button or disabled message', async ({ adminPage: page }) => {
      await page.goto('/index.php?page=whois');
    ...
    test('should have placeholder text or disabled message', async ({ adminPage: page }) => {
      await page.goto('/index.php?page=whois');
    ...
    test('should display help text or disabled message', async ({ adminPage: page }) => {
      await page.goto('/index.php?page=whois');
    ...
    test('should include CSRF token when enabled', async ({ adminPage: page }) => {
      await page.goto('/index.php?page=whois');
  ...
  test.describe('Form Submission', () => {
    test('should accept domain input when enabled', async ({ adminPage: page }) => {
      await page.goto('/index.php?page=whois');
    ...
    test('should submit lookup request when enabled', async ({ adminPage: page }) => {
      await page.goto('/index.php?page=whois');
    ...
    test('should handle empty domain submission when enabled', async ({ adminPage: page }) => {
      await page.goto('/index.php?page=whois');
      ...
      if (await lookupBtn.count() > 0) {
        await lookupBtn.click();
        await expect(page).toHaveURL(/page=whois/);
      } else {
        expect(bodyText.toLowerCase()).toContain('disabled');
      }
    });
  ...
  test.describe('Results Display', () => {
    test('should display results section after lookup when enabled', async ({ adminPage: page }) => {
      await page.goto('/index.php?page=whois');
    ...
    test('should show results or alert when enabled', async ({ adminPage: page }) => {
      await page.goto('/index.php?page=whois');
    ...
    test('should handle invalid domain when enabled', async ({ adminPage: page }) => {
      await page.goto('/index.php?page=whois');
  ...
  test.describe('IDN Domain Support', () => {
    test('should accept internationalized domain names when enabled', async ({ adminPage: page }) => {
      await page.goto('/index.php?page=whois');
  ...
  test.describe('UI Elements', () => {
    test('should have search icon or disabled message', async ({ adminPage: page }) => {
      await page.goto('/index.php?page=whois');
    ...
    test('should use input group styling or show disabled message', async ({ adminPage: page }) => {
      await page.goto('/index.php?page=whois');
    ...
    test('should have card layout or show disabled message', async ({ adminPage: page }) => {
      await page.goto('/index.php?page=whois');
